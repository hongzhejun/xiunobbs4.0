...
function _typeof(o) {
	...
	function r(o, e) {
		...
		if (a(t, e)) {
			var s = t.split(/\s+/),
				r = s.indexOf(e);
			s.splice(r, 1), o.className = s.join(" ")
		}
	...
	function n(s) {
		var a = s.type,
			...
			m = 0 === c,
			h = l();
		"loading" == a && (n = "" === n ? "æ­£åœ¨åŠ è½½ï¼Œè¯·ç¨åŽ" : n, m = d, c = 0);
		var u = o({
		...
		}), "onanimationend" in window ? e(b, function() {
			f(u, g)
		}) : setTimeout(function() {
			f(u, g)
	...
	function f(o, e) {
		o && (t(o, {
			...
			if (o) {
				for (var e = !1, t = 0; t < p.children.length; t++) p.children[t] === o && (e = !0);
				e && d(o), o = null, p.children.length || e && d(p)
			}
		}, 300))
	}
	...
	function m() {
		...
		if (o && o.head) {
			...
			t.innerHTML = s, e.children.length ? e.insertBefore(t, e.children[0]) : e.appendChild(t)
		}
	}
	var p = o({
